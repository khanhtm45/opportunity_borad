-- ============================================================================
-- DEMO SEED — Opportunity Board
-- Chạy SAU schema + migration 003.
-- Password tất cả user demo: password123
-- Ảnh: placehold.co + dicebear (CDN ổn định, không phụ thuộc hotlink hỏng)
-- Idempotent: xóa data demo cũ theo email *@demo.ob.local rồi insert lại.
-- ============================================================================

BEGIN;

-- 0) Đảm bảo cột F03 đã có (idempotent)
